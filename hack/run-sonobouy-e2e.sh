...
cp $(pwd)/test/kubean_sonobouy_e2e/e2e-install-cluster-sonobouy/kubeanClusterOps.yml $(pwd)/test/kubean_sonobouy_e2e/e2e-upgrade-cluster/
cp $(pwd)/test/kubean_sonobouy_e2e/e2e-install-cluster-sonobouy/kubeanClusterOps.yml $(pwd)/test/kubean_sonobouy_e2e/e2e-upgrade-cluster24/
...
cp $(pwd)/test/kubean_sonobouy_e2e/e2e-install-cluster-sonobouy/hosts-conf-cm.yml $(pwd)/test/kubean_sonobouy_e2e/e2e-upgrade-cluster24/
cp $(pwd)/test/kubean_sonobouy_e2e/e2e-install-cluster-sonobouy/vars-conf-cm.yml $(pwd)/test/kubean_sonobouy_e2e/e2e-upgrade-cluster24/
cp $(pwd)/test/kubean_sonobouy_e2e/e2e-install-cluster-sonobouy/kubeanCluster.yml $(pwd)/test/kubean_sonobouy_e2e/e2e-upgrade-cluster24/
sed -i "s/v1.22.12/v1.24.3/" $(pwd)/test/kubean_sonobouy_e2e/e2e-upgrade-cluster24/vars-conf-cm.yml
sed -i "s#image:#image: ${SPRAY_JOB}#" $(pwd)/test/kubean_sonobouy_e2e/e2e-upgrade-cluster24/kubeanClusterOps.yml
